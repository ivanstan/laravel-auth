...
export default function Login(props: Props) {
    const {canResetPassword, status} = props;
        ...
        <AuthenticationCard>
            ...
            <form onSubmit={onSubmit}>
              ...
              Remember me
                ...
                {props.socialstream.show && props.socialstream.providers.length && (
                    <SocialStream prompt={props.socialstream.prompt}
                                  providers={props.socialstream.providers} error={props.errors.socialstream}/>
                )}
